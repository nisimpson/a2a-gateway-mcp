...
// registerTools is the old registration path. Replaced by registerToolsV2().
// Kept temporarily because test files reference input/output types defined
// above and some handler methods indirectly.

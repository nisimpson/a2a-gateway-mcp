...
var _ HistoryBackend = (*FileBackend)(nil)
...
func (f *FileBackend) readEntries(alias string) ([]HistoryEntry, error) {
...
func (f *FileBackend) writeEntries(alias string, entries []HistoryEntry) error {
...
func (f *FileBackend) Append(_ context.Context, alias string, entry HistoryEntry) error {
...
func (f *FileBackend) List(_ context.Context, alias string) ([]HistoryEntry, error) {
	lock := f.aliasLock(alias)
	lock.RLock()
	defer lock.RUnlock()

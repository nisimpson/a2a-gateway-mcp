...
var _ HistoryBackend = (*MemoryBackend)(nil)
...
func (m *MemoryBackend) Append(_ context.Context, alias string, entry HistoryEntry) error {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *MemoryBackend) List(_ context.Context, alias string) ([]HistoryEntry, error) {
	m.mu.RLock()
	defer m.mu.RUnlock()
